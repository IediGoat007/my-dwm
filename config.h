...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_equal,  spawn,          SHCMD ("pactl set-sink-volume @DEFAULT_SINK@ +5%")},
	{ MODKEY|ControlMask,           XK_minus,  spawn,          SHCMD ("pactl set-sink-volume @DEFAULT_SINK@ -5%")},
