...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_equal,  spawn,          SHCMD ("pactl set-sink-volume 64 +5% && pkill -RTMIN+1 -f ~/github/my-dwm/status")},
	{ MODKEY|ControlMask,           XK_minus,  spawn,          SHCMD ("pactl set-sink-volume 64 -5% && pkill -RTMIN+1 -f ~/github/my-dwm/status")},
